		...
		<table class="table table-bordered table-striped" id="tabla_lista">
			...
			<tbody>
				...
				foreach($arr as $objeto)
				{
					...
					<td><button class='btn btn-info btn-xs btn-editar' folio='$objeto->folio'><span class='glyphicon glyphicon-edit'></span>Editar</button> <button class='btn btn-danger btn-xs btn-eliminar' folio='$objeto->folio'><span class='glyphicon glyphicon-trash'></span>Eliminar</button></td>
					</tr>";
				}
					?>
