...
<div>
  ...
  <table width="639">
    <tr>
      <td width="106" height="28" align="center"><?php echo $servicio->folio?><input type="hidden" name="folio" value="<?php echo $servicio->folio?>"></td>
      <td width="199" align="center"><input type="text" name="nombre"  size="20" value="<?php echo $servicio->nombre ?>"/></td>
      <td width="163"  align="center"><input type="text" name="apellidop" value="<?php echo $servicio->apellidoPaterno ?>" /></td>
      <td width="151"  align="center"><input type="text" name="apellidom" size="20"  value="<?php echo $servicio->apellidoMaterno ?>"/></td>
      </tr>
    <tr>
    ...
    <tr>
    	<td align="left"><strong>Fecha: <input type="text" size="10" id="fecha" name="fecha" readonly value="<?php echo $servicio->fecha?>"  ></strong></td>
    ...
    <?php
		...
		foreach($arr_s as $objeto)
		{
			...
			echo " <option value='$objeto->id_servicio' $seleccionado >".($objeto->nom_servicio)."</option> ";
		}
		?>
      </select></td>
        ...
        <select name="tipofuga" id="tipofuga">
          <?php
			...
			foreach($arr_f as $objeto)
			{
				...
				echo " <option value='$objeto->id_fuga' $seleccionado>".utf8_encode($objeto->nom_fuga)."</option> "; 
			}
          ?>
        <td aling="left" id="oculto2"><lab></label>
        	<select name="tipoconexion" id="tipoconexion">
				...
				$seleccionado="";
					...
					echo "<option value='$objeto->id_reconexion' $seleccionado >".utf8_encode($objeto->nom_reconexion)."</option>";	
				}
        		?>
        	</select>
    ...
    <tr>
      ...
      <td height="35"><strong>Colonia:
        </strong>        <input type="text" name="colonia" id="colonia" value="<?php echo $servicio->colonia?>" /></td>
      <td  height="30"><strong>calle:</strong>        <input type="text" name="calle"  size="20" id="calle" value="<?php echo $servicio->calle?>" /></td>
      <td height="35"><strong>No.</strong> <input type="text" name="no" id="no" size="5" value="<?php echo $servicio->no?>" /></td>
      </tr>
    <tr>
      <td><strong>Entre que Calles:</strong></td>
      <td height="30" align="left">
        <input type="text" name="entrecalles" id="entrecalles"  size="20"  value="<?php echo $servicio->entrecalles?>"/>
    </td>
      <td align="center"><strong>Cuenta:
          <input type="text" name="cuenta" id="cuenta" maxlength="5" size="10" value="<?php echo $servicio->cuenta?>" />
      </strong></td>
      <td align="left"><strong>Prioridad:</strong>
        <select name="prioridad" id="prioridad">
          <option value=0 <?php echo ($servicio->prioridad==0?'selected':'') ?> >Ordinario</option>
          <option value=1 <?php echo ($servicio->prioridad==1?'selected':'') ?>>Urgente</option>
        </select></td>
    </tr>
    <tr>
      <td><strong>Referencia:</strong></td>
      <td height="30" align="left"><input type="text" name="referencia" id="referencia" size="20" value="<?php echo $servicio->referencia?>" /></td>
      <td align="letf"><strong>Telefono</strong>:        <input type="text" name="telefono" id="telefono" size="10" value="<?php echo $servicio->telefono?>" /></td>
      <td align="left" id="hora"><strong>Hora: <input name="hora" id="hora" type="hidden" /></strong></td>
      </tr>
	<tr>
	  <td height="41" colspan="4"><center><input type="button" name="enviar" id="enviar" value="Actualizar" /></center></td>
	  </tr>
  </table>
  </form>
